    ...
    <Layout>
      <div className="min-h-screen py-20 px-6 lg:px-12 xl:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <div className="space-y-8">
              {educationData.map((edu, index) => (
                <Card key={index} className={`p-8 hover-lift bg-white border-l-4 ${edu.status === 'current' ? 'border-l-portfolio-blue' : 'border-l-portfolio-blue-dark'} animate-slide-in-left`}>
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                    <div className="flex items-center gap-3 mb-2 lg:mb-0">
                      <div className={`w-3 h-3 rounded-full ${edu.status === 'current' ? 'bg-portfolio-blue' : 'bg-portfolio-blue-dark'}`}></div>
          ...
          {/* Certifications */}
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8 font-poppins">Certifications</h2>
            <div className="grid lg:grid-cols-2 gap-8">
              {certifications.map((cert, index) => (
                <Card key={index} className="p-8 hover-lift bg-white border-portfolio-blue/20 animate-slide-in-right">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <Award className="w-8 h-8 text-portfolio-blue-dark flex-shrink-0 ml-4" />
                  </div>
