...
//           {/* Left Content */}
//           <div className="w-full lg:w-1/2 px-6 lg:px-12 xl:px-20 z-10">
...
//               <div className="w-80 h-80 rounded-full bg-gradient-to-br from-portfolio-blue to-portfolio-blue-dark flex items-center justify-center text-white text-6xl font-bold shadow-2xl">
//                 DK
//               </div>
//             </div>
//           </div>
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative h-screen flex items-center">
          ...
          <div className="w-full lg:w-1/2 px-6 lg:px-12 xl:px-20 z-10">
            ...
            */}
            <div className="max-w-2xl animate-slide-in-left translate-x-8">
              <p className="text-lg text-gray-600 mb-4 font-inter">Hi, I am</p>
              <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-6 font-poppins leading-tight">
                Dev Kansara
              </h1>
          ...
          <div className="hidden lg:block lg:w-1/2 h-full relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center animate-slide-in-right">
              ...
              */}
              <div className="w-80 h-80 rounded-full bg-gradient-to-br from-portfolio-blue to-portfolio-blue-dark flex items-center justify-center shadow-2xl overflow-hidden -translate-x-8">
                <img
                  src="/myImg.png" // Assumes myImg.png is in your public folder
